...
\begin{figure}[H]
	...
	\parbox{0.484\textwidth}{
		\centering
		\begin{subfigure}[b]{\linewidth}{
				\subcaptionbox{\label{fig:fakeVertexEventsa}}{\includegraphics[width=\linewidth, page=19]{graphics/chargedMC/bkg0max.pdf}}}
		\end{subfigure}
	}
	\quad
	\parbox{0.484\textwidth}{
		\centering
		\begin{subfigure}[b]{\linewidth}{
				\subcaptionbox{\label{fig:fakeVertexEventsb}}{\includegraphics[width=\linewidth, page=15]{graphics/chargedMC/bkg1max.pdf}}}
		\end{subfigure}
	}
...
\begin{figure}[H]
	...
	\parbox{0.3\textwidth}{
		\centering
		\begin{subfigure}[b]{\linewidth}{
				\subcaptionbox{\label{fig:vertexAdditionala}}{\includegraphics[width=\linewidth, page=4]{graphics/vertexing/vertexEffi.pdf}}}
		\end{subfigure}
	}
	\quad
	\parbox{0.3\textwidth}{
		\centering
		\begin{subfigure}[b]{\linewidth}{
				\subcaptionbox{\label{fig:vertexAdditionalb}}{\includegraphics[width=\linewidth, page=7]{graphics/vertexing/vertexEffi.pdf}}}
		\end{subfigure}
	}
	\parbox{0.3\textwidth}{
		\centering
		\begin{subfigure}[b]{\linewidth}{
				\subcaptionbox{\label{fig:vertexAdditionalc}}{\includegraphics[width=\linewidth, page=10]{graphics/vertexing/vertexEffi.pdf}}}
		\end{subfigure}
	}
	\quad
	\parbox{0.3\textwidth}{
		\centering
		\begin{subfigure}[b]{\linewidth}{
				\subcaptionbox{\label{fig:vertexAdditionald}}{\includegraphics[width=\linewidth, page=13]{graphics/vertexing/vertexEffi.pdf}}}
		\end{subfigure}
	}
	\parbox{0.3\textwidth}{
			\centering
			\begin{subfigure}[b]{\linewidth}{
					\subcaptionbox{\label{fig:vertexAdditionale}}{\includegraphics[width=\linewidth, page=16]{graphics/vertexing/vertexEffi.pdf}}}
			\end{subfigure}
		}
...
\begin{figure}[H]
	...
	\parbox{0.3\textwidth}{
		\centering
		\begin{subfigure}[b]{\linewidth}{
				\subcaptionbox{\label{fig:vertexAdditionalZa}}{\includegraphics[width=\linewidth, page=22]{graphics/vertexing/vertexEffi.pdf}}}
		\end{subfigure}
	}
	\quad
	\parbox{0.3\textwidth}{
		\centering
		\begin{subfigure}[b]{\linewidth}{
				\subcaptionbox{\label{fig:vertexAdditionalZb}}{\includegraphics[width=\linewidth, page=25]{graphics/vertexing/vertexEffi.pdf}}}
		\end{subfigure}
	}
	\parbox{0.3\textwidth}{
		\centering
		\begin{subfigure}[b]{\linewidth}{
				\subcaptionbox{\label{fig:vertexAdditionalZc}}{\includegraphics[width=\linewidth, page=28]{graphics/vertexing/vertexEffi.pdf}}}
		\end{subfigure}
	}
	\quad
	\parbox{0.3\textwidth}{
		\centering
		\begin{subfigure}[b]{\linewidth}{
				\subcaptionbox{\label{fig:vertexAdditionalZd}}{\includegraphics[width=\linewidth, page=31]{graphics/vertexing/vertexEffi.pdf}}}
		\end{subfigure}
	}
	\parbox{0.3\textwidth}{
			\centering
			\begin{subfigure}[b]{\linewidth}{
					\subcaptionbox{\label{fig:vertexAdditionalZe}}{\includegraphics[width=\linewidth, page=34]{graphics/vertexing/vertexEffi.pdf}}}
			\end{subfigure}
		}
