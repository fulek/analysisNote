...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.41\textwidth,page=1]{chapters/chrgSTAR/img/syst/out_chargedmax.pdf}
	\hfill
	\includegraphics[width=.41\textwidth,page=7]{chapters/chrgSTAR/img/syst/out_chargedmax.pdf}
	\newline
	\includegraphics[width=.41\textwidth,page=13]{chapters/chrgSTAR/img/syst/out_chargedmax.pdf}
	\hfill
	\includegraphics[width=.41\textwidth,page=19]{chapters/chrgSTAR/img/syst/out_chargedmax.pdf}
	%
	...
	\vspace*{\floatsep}
	\centering
	\includegraphics[width=.41\textwidth,page=5]{chapters/chrgSTAR/img/syst/out_chargedmax.pdf}
	\hfill
