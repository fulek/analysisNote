...
Figure~\ref{fig:results_star_eta} shows primary charged-particle multiplicity as a function of $\bar{\eta}$ %(defined in Sec.~\ref{section:definitionEtaBar}) 
 ...
 %Models describe data fairly well for $0.02<\xi<0.05$ except EPOS SD which predicts smaller charged-particle density. All MCs, but  EPOS SD$^\prime$ and HERWIG-SD, predict less steep dependence of particle density with $\bar{\eta}$ in the~range of $0.05 < \xi < 0.2$.
 % except EPOS-SD which predicts flat $\bar{\eta}$ distributions in all three $\xi$ ranges.
